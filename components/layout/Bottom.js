                    ...
                    <div className="row">
                        <div className="col-xl-4 col-lg-4 col-md-7 col-sm-8">
                            <div className="bottom-logo">
                                ...
                                <p>
                                    LFS Industries es una empresa dedicada al desarrollo de software a medida.
                                    Ayuda a realizar todas las peticiones que desees, tal cual en tu mente lo imagines,
                                    a medida de tu empresa y tu publico.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6">
                            <div className="bottom-widget">
                                <h4 className="widget-title">Configuración</h4>
                                <ul>
                                    <li>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-8 col-sm-8">
                            <div className="bottom-widget">
                                <h4 className="widget-title">Perfil</h4>
                                <div className="row">
